...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Rainbow Eyesore', "Value 1: Step to end the rainbow eyesore\nValue 2: Speed"]
	];
	...
	**/
	...
	function addOtherUI() {
		...
		tab_group_other.add(creditInputText);
		tab_group_other.add(new FlxText(creditInputText.x, creditInputText.y - 15, 0, 'Song Credit:'));
		tab_group_other.add(screwYouInputText);
		tab_group_other.add(new FlxText(screwYouInputText.x, screwYouInputText.y - 15, 0, 'Screw You Text:'));
